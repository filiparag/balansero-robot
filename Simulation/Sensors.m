function [ o_angle, o_current_states ] = ...
    ...
    Rotation_angle_steps = i_wheel_rotation / Rotary_encoder_steps;
    ...
    Rotation_angle_steps = Encoder_Noise(Rotation_angle, 5);

    % Get angle using complementary filter
    o_angle = Complementary_Filter(Angular_velocity, Linear_acceleration, [Rotation_angle_steps, Rotary_encoder_steps], i_previous_angle);
