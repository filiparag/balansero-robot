function [ o_state_estimate, o_error_estimate ] = Kalman_filter( i_control, i_measurement, i_state_previous, i_error_previous, i_transfer_function )
    ...
    % Coverting transfer function to state space
    ...
    State_transition_matrix = tf2ss(Numerator_vector, Denominator_vector);
